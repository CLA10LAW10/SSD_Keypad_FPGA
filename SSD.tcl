...
set files [list \
 [file normalize "${origin_dir}/src/disp_ctrl.sv"] \
 [file normalize "${origin_dir}/src/keypad_decoder.sv"] \
 [file normalize "${origin_dir}/src/debounce.vhd"] \
 [file normalize "${origin_dir}/src/single_pulse_detector.vhd"] \
 [file normalize "${origin_dir}/src/ssd_top.sv"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/src/disp_ctrl.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/src/keypad_decoder.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set file "$origin_dir/src/ssd_top.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "ssd_top" -objects $obj
...
set file "[file normalize "$origin_dir/constr/SSD-Zybo-Z7.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constr/SSD-Zybo-Z7.xdc"
set file [file normalize $file]
